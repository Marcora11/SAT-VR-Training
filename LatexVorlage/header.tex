...
% Generierung der Timeline
\newcommand\ytl[4]{
\parbox[b]{6em}{\hfill{\color{cyan}\bfseries\sffamily #1}~$\cdots\cdots$~}\makebox[0pt][c]{$\bullet$}\vrule\quad \parbox[c]{9.5cm}{\vspace{4pt}\color{black}\raggedright\sffamily #2 --- #3 --- #4\\[5pt]}\\[-3pt]}
...
% Entfernen unnötiger Kommentare in IEEE Literatur
